...
## Report bugs using GitHub's [issue tracker](https://github.com/yourusername/next-blog-template/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/yourusername/next-blog-template/issues/new).
